...
const OfficersPage = () => {
  ...
  const fetchAllData = async () => {
    try {
      const allVotersResponse = await fetchData(`${import.meta.env.VITE_SERVER_URL}/api/officer/all`);
      const votedVotersResponse = await fetchData(`${import.meta.env.VITE_SERVER_URL}/api/officer/voted`);
      const pendingVotersResponse = await fetchData(`${import.meta.env.VITE_SERVER_URL}/api/officer/pending`);
      const candidatesResponse = await fetchData(`${import.meta.env.VITE_SERVER_URL}/api/officer/candidates`);
      const officerResponse = await fetchData(`${import.meta.env.VITE_SERVER_URL}/api/officer/details`);
